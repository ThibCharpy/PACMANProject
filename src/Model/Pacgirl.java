...
public class Pacgirl extends Monster{

    public int lifeLeft;
    public String state = "idle";
    public int timerPower = 0;
    ...
    /**
     * Fonction gérant les intéracrions de pacgirl en mode VersusPaint
     */
    @Override
    public void paintInteract() {
        ...
        if((getInfoCase(x + (width / 2), y + (height / 2)) == 7) && (state.equals("power"))){
            paint();
        }
    }

    /**
     * Fonction créant une demande de changement de Sprites pour le mode VersusPaint, change un sprites "vide" ou égal a 0 ( fond noir ) en fond bleu égal a 8.
     */
    private void paint() {
        //if (getInfoCase(x + (width / 2), y + (height / 2)) == 0) {
        setInfoCase(x + (width / 2), y + (height / 2), 8);
        MapChangeRequest m= new MapChangeRequest(getMonster_Case_Y(y + (height / 2)/*Pos_Y*/), getMonster_Case_X(x + (width / 2)/*Pos_X*/), "/Sprites/paint_pink.png", "Gomme");
        ChangeQueue.add(m);
    ...
    private void EatBigGomme(double Pos_X, double Pos_Y) {
        if (getInfoCase(x + (width / 2), y + (height / 2)) == 3) {
            setInfoCase(x + (width / 2), y + (height / 2), 2);
